...
> | завершённые | `finished=<что угодно>`: `1`, `y`, `n` дают одно и то же (сериалы 7960 → 4703) — сервер смотрит на наличие параметра; `finished=0` игнорируется, «идущих» не выбрать |
>
